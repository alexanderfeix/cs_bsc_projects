...
public class DirectionRightCommand extends Command {
    public DirectionRightCommand(CommandTypeInfo commandTypeInfo, Object[] params) {
        super(commandTypeInfo, params);
    }

    @Override
    public void handle(GameImpl game){
        game.getUi().setNextDirection(Direction.RIGHT);
    }
}
